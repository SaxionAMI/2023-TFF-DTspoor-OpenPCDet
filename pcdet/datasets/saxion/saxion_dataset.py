...
class SaxionDataset(DatasetTemplate):
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            class_names=['pole', 'tension_rod', 'signal', 'cabinet'],
            data_path=ROOT_DIR / 'data' / 'saxion',
            save_path=ROOT_DIR / 'data' / 'saxion',
        )
